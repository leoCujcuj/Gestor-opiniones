    ...
    'Role',
    {
        ...
        Name: {
            ...
            validate: {
                ...
                isIn: {
                    args: [ALLOWED_ROLES],
                    msg: 'Rol no permitido. Use ADMIN o USER_ROLE.',
                },
            },
        },
        CreatedAt: {
...
UserRole.belongsTo(User, { as: 'User', foreignKey: 'UserId' }); // Agregamos esta para poder hacer include desde UserRole

// Un Rol pertenece a muchos usuarios (a través de la tabla intermedia)
